...
#define PINFUNC_EZH		4
#define PINFUNC_GPIO	0

#define NEED_DELAY	1

#define time_delay_us 100 * 96 // first factor is time, the maximum is 680us under 96MHz.
...
__asm void EZH_CODE EZH_KeyScan(void)
{
    ...
    E_BCLR_IMM(GPD, GPD, KEY_COLUMN_4)
		...
		E_HEART_RYTHM_IMM(time_delay_us)
kdown /* detect key down */		
    ...
    E_COND_OR(ZE, R0, R0, R1) /* bit 0 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_2)
    E_COND_LSL_OR(ZE, R0, R0, R1, 1) /* bit 1 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_3)
    E_COND_LSL_OR(ZE, R0, R0, R1, 2) /* bit 2 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_4)
    E_COND_LSL_OR(ZE, R0, R0, R1, 3) /* bit 3 */
...
#endif	
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_1)
    E_COND_LSL_OR(ZE, R0, R0, R1, 4) /* bit 4 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_2)
    E_COND_LSL_OR(ZE, R0, R0, R1, 5) /* bit 5 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_3)
    E_COND_LSL_OR(ZE, R0, R0, R1, 6) /* bit 6 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_4)
    E_COND_LSL_OR(ZE, R0, R0, R1, 7) /* bit 7 */
...
#endif
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_1)
    E_COND_LSL_OR(ZE, R0, R0, R1, 8) /* bit 8 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_2)
    E_COND_LSL_OR(ZE, R0, R0, R1, 9) /* bit 9 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_3)
    E_COND_LSL_OR(ZE, R0, R0, R1, 10) /* bit 10 */	
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_4)
    E_COND_LSL_OR(ZE, R0, R0, R1, 11) /* bit 11 */
...
#endif	
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_1)
    E_COND_LSL_OR(ZE, R0, R0, R1, 12) /* bit 12 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_2)
    E_COND_LSL_OR(ZE, R0, R0, R1, 13) /* bit 13 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_3)
    E_COND_LSL_OR(ZE, R0, R0, R1, 14) /* bit 14 */	
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_4)
    E_COND_LSL_OR(ZE, R0, R0, R1, 15) /* bit 15 */
...
#endif
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_1)
    E_COND_OR(ZE, R2, R2, R3) 			 /* bit 0 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_2)
    E_COND_LSL_OR(ZE, R2, R2, R3, 1) /* bit 1 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_3)
    E_COND_LSL_OR(ZE, R2, R2, R3, 2) /* bit 2 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_4)
    E_COND_LSL_OR(ZE, R2, R2, R3, 3) /* bit 3 */
    E_BSET_IMM(GPO, GPO, KEY_ROW_1)
		/* Scan 2nd row */		
    E_BCLR_IMM(GPO, GPO, KEY_ROW_2)
#if NEED_DELAY
...
#endif
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_1)
    E_COND_LSL_OR(ZE, R2, R2, R3, 4) /* bit 4 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_2)
    E_COND_LSL_OR(ZE, R2, R2, R3, 5) /* bit 5 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_3)
    E_COND_LSL_OR(ZE, R2, R2, R3, 6) /* bit 6 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_4)
    E_COND_LSL_OR(ZE, R2, R2, R3, 7) /* bit 7 */
    E_BSET_IMM(GPO, GPO, KEY_ROW_2)
		/* Scan 3rd row */		
    E_BCLR_IMM(GPO, GPO, KEY_ROW_3)	
#if NEED_DELAY
...
#endif
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_1)
    E_COND_LSL_OR(ZE, R2, R2, R3, 8) /* bit 8 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_2)
    E_COND_LSL_OR(ZE, R2, R2, R3, 9) /* bit 9 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_3)
    E_COND_LSL_OR(ZE, R2, R2, R3, 10) /* bit 10 */	
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_4)
    E_COND_LSL_OR(ZE, R2, R2, R3, 11) /* bit 11 */		
    E_BSET_IMM(GPO, GPO, KEY_ROW_3)	
		/* Scan 4th row */		
    E_BCLR_IMM(GPO, GPO, KEY_ROW_4)
#if NEED_DELAY
...
#endif		
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_1)
    E_COND_LSL_OR(ZE, R2, R2, R3, 12) /* bit 12 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_2)
    E_COND_LSL_OR(ZE, R2, R2, R3, 13) /* bit 13 */
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_3)
    E_COND_LSL_OR(ZE, R2, R2, R3, 14) /* bit 14 */	
    E_BTST_IMMS(GPI, GPI, KEY_COLUMN_4)
    E_COND_LSL_OR(ZE, R2, R2, R3, 15) /* bit 15 */		
    E_BSET_IMM(GPO, GPO, KEY_ROW_4)
...
//		PRINTF("queue_1.ezh_write: 0x%x \r\n",queue_1.ezh_write);
		...
		for(i = 0 ;i < count; i++ ){
			...
			switch(keyvalue[i] & 0xFFFF){
				case 0x1:		PRINTF("key_value: S1  \r\n");break;
				case 0x2:		PRINTF("key_value: S2  \r\n");break;
				case 0x4:		PRINTF("key_value: S3  \r\n");break;
				case 0x8:		PRINTF("key_value: S4  \r\n");break;
				case 0x10:	PRINTF("key_value: S5  \r\n");break;
				case 0x20:	PRINTF("key_value: S6  \r\n");break;
				case 0x40:	PRINTF("key_value: S7  \r\n");break;
				case 0x80:	PRINTF("key_value: S8  \r\n");break;
				case 0x100:	PRINTF("key_value: S9  \r\n");break;
				case 0x200:	PRINTF("key_value: S10 \r\n");break;
				case 0x400:	PRINTF("key_value: S11 \r\n");break;
				case 0x800:	PRINTF("key_value: S12 \r\n");break;
				case 0x1000:PRINTF("key_value: S13 \r\n");break;
				case 0x2000:PRINTF("key_value: S14 \r\n");break;
				case 0x4000:PRINTF("key_value: S15 \r\n");break;
				case 0x8000:PRINTF("key_value: S16 \r\n");break;
				default:	break;
			}			
...
void EZH_Pin_Init(void){
	...
	IOCON->PIO[0][KEY_COLUMN_1]		= PINFUNC_EZH | 2<<3 | 1<<7 | 1<<8;
	IOCON->PIO[0][KEY_COLUMN_2] 	= PINFUNC_EZH | 2<<3 | 1<<7 | 1<<8;
	IOCON->PIO[0][KEY_COLUMN_3] 	= PINFUNC_EZH | 2<<3 | 1<<7 | 1<<8;
	IOCON->PIO[0][KEY_COLUMN_4]		= PINFUNC_EZH | 2<<3 | 1<<7 | 1<<8;
