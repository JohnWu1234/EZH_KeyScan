...
#define IOCON_PIO_FUNC5               0x05u   /*!< Selects pin function 1 */
...
#define PIN4_IDX                         4u   /*!< Pin number for pin 1 in a port 0 */
#define PIN9_IDX                         9u   /*!< Pin number for pin 1 in a port 0 */
...
void BOARD_InitPins(void) { /* Function assigned for the Cortex-M0P */
  ...
  IOCON_PinMuxSet(IOCON, PORT1_IDX, PIN9_IDX, port1_pin9_config); /* PORT0 PIN0 (coords: 31) is configured as FC0_RXD_SDA_MOSI */
  const uint32_t port1_pin4_config = (
    IOCON_PIO_FUNC5 |                                        /* Pin is configured as FC0_TXD_SCL_MISO */
    IOCON_PIO_MODE_INACT |                                   /* No addition pin function */
    IOCON_PIO_INV_DI |                                       /* Input function is not inverted */
    IOCON_PIO_DIGITAL_EN |                                   /* Enables digital function */
    IOCON_PIO_INPFILT_OFF |                                  /* Input filter disabled */
  ...
  IOCON_PinMuxSet(IOCON, PORT1_IDX, PIN4_IDX, port1_pin4_config); /* PORT0 PIN1 (coords: 32) is configured as FC0_TXD_SCL_MISO */
